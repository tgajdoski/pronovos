...
// vrti po sekoj pdf of dir i pravi 
  ...
  pdfSrc = 'http://drawback.rubixcubesolutions.com/uploads/split/file-1489246452855/page00001.pdf';
  page:number = 1;
 ...
 //console.log( this.filepdfList);
  ...
  gets3imageUrl(foldername: any, filename:any) {
    ...
    //      console.log(res);
    //   });
    this.src = "http://drawback.rubixcubesolutions.com/"+foldername+"/"+filename;
   }
}
